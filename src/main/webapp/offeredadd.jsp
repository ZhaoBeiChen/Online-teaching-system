                      ...
                      <section class="panel">
                          ...
                          <script>
                            $(document).ready(function(){
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form" action="OfferedAdd" method="post" >
                                      <div class="form-group ">
                                          <label for="courseid" class="control-label col-lg-2">课程名称 <span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <select class=" form-control" id="courseid" name="offered.courseid" type="text" >
                                              </select>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="teacherid" class="control-label col-lg-2">开课教师<span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <select class=" form-control" id="teacherid" name="offered.teacherid" type="text" >
                                              </select>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="datestart" class="control-label col-lg-2">开课日期<span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input type="date" id="datestart" name="offered.datestart"/>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="dateend" class="control-label col-lg-2">结课日期<span class="required">*</span></label>
                                          <div class="col-lg-10">
